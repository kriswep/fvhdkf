          ...
          <div id="main">
            ...
            <section id="second" className="main special">
              ...
              <p className="content">
                ...
                magna libero. Morbi auctor iaculis porttitor. Sed ut magna ac
                risus et hendrerit scelerisque. Praesent eleifend lacus in
                lectus aliquam porta. Cras eu ornare dui curabitur lacinia.
              </p>
              <footer className="major">
                <ul className="actions">
                  <li>
